          ...
          renderCell: (params) => {
            return (
              <div className="cellAction">
                <Link  state={{course_id:params.id}} style={{ textDecoration: "none" }} onClick={()=>{handleApplicationAction(params.row._id,"accepted")}} >
                  <div className="viewButton">Approve</div>
                </Link>
                <Link state={{course_id:params.id}} style={{ textDecoration: "none" }} onClick={()=>{handleApplicationAction(params.row._id,"rejected")}} >
                  <div className="viewButton">Reject</div>
                </Link>
                {user.role==='admin'?'':
                <Link state={{course_id:params.id}} style={{ textDecoration: "none" }} onClick={()=>{handleApplicationAction(params.row._id,"forwarded")}} >
